    ...
    <section className="max-w-5xl mx-auto p-8">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div>
          ...
          <h2 className="text-lg text-gray-400">Mechanical Engineer, Full-Stack Web Developer</h2>
          <p className="text-gray-300 mt-2">
            Passionate about building scalable applications with **Next.js, Supabase, PostgreSQL**, and modern frontend technologies.
          </p>
          {/* Social Links */}
      ...
      {/* Background & Skills */}
      <div className="mt-10">
        <h2 className="text-3xl text-accent-400 font-medium">My Background and Skills</h2>
        <p className="text-gray-300 mt-4">
          I am a Full-Stack Web Developer with a deep interest in modern technologies, specializing in **Next.js, React, TailwindCSS, Supabase, PostgreSQL, and Firebase**. I focus on building scalable and efficient web applications that deliver great user experiences.
        </p>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-6 mt-4">
          ...
          <Image src="/icons/tailwind.svg" alt="TailwindCSS" width={40} height={40} />
      ...
      <div className="mt-10 text-center">
        <h2 className="text-3xl text-accent-400 font-medium">Download My Resume</h2>
        <p className="text-gray-300 mt-2">Click below to get a copy of my latest resume.</p>
         <a
            href="/resume.pdf"
        ...
        {showResume && (
          <div className="mt-6">
            <iframe src="/resume.pdf" className="w-full h-[600px] border rounded-lg" title="Resume Viewer"></iframe>
          </div>
        )}
      </div>
      ...
      <div className="mt-10 text-center">
        ...
        <p className="text-gray-300 mt-4">Interested in working together? Let’s have a chat.</p>
        <Link href="/contact">

    ...
    <section className="max-w-5xl mx-auto p-8">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div>
          ...
          <p className="text-gray-300 mt-2">
            Passionate about building scalable applications with **Next.js,
            Supabase, PostgreSQL**, and modern frontend technologies.
          </p>
          {/* Social Links */}
      ...
      <div className="mt-10">
        ...
        <p className="text-gray-300 mt-4">
          ...
          technologies, specializing in **Next.js, React, TailwindCSS, Supabase,
          PostgreSQL, and Firebase**. I focus on building scalable and efficient
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-6 mt-4">
          ...
          <Image src="/snowflake2.svg" alt="Firebase" width={80} height={80} />
        </div>
      </div>
